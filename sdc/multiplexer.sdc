...
# Fri Nov  3 19:05:37 2023
###############################################################################
current_design multiplexer
###############################################################################
# Timing Constraints
###############################################################################
create_clock -name clk -period 17.0000 [get_ports {wb_clk_i}]
set_clock_transition 0.1500 [get_clocks {clk}]
set_clock_uncertainty 0.2500 clk
set_propagated_clock [get_clocks {clk}]
set_clock_latency -source -min 4.6500 [get_clocks {clk}]
set_clock_latency -source -max 5.5700 [get_clocks {clk}]
set_input_delay 10.5000 -clock [get_clocks {clk}] -add_delay [get_ports {wb_rst_i}]
...
set_load -pin_load 0.1900 [get_ports {qcpu_sram_out[7]}]
set_load -pin_load 0.1900 [get_ports {qcpu_sram_out[6]}]
set_load -pin_load 0.1900 [get_ports {qcpu_sram_out[5]}]
set_load -pin_load 0.1900 [get_ports {qcpu_sram_out[4]}]
set_load -pin_load 0.1900 [get_ports {qcpu_sram_out[3]}]
set_load -pin_load 0.1900 [get_ports {qcpu_sram_out[2]}]
set_load -pin_load 0.1900 [get_ports {qcpu_sram_out[1]}]
set_load -pin_load 0.1900 [get_ports {qcpu_sram_out[0]}]
