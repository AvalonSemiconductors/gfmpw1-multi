...
public class PlacementPreview {
	...
	public static void main(String[] args) {
		...
		Macro[] macros = new Macro[] {
			new Macro(925, 1200, 750, 700, Color.GREEN, "Multiplexer"), //Multiplexer
			...
			new Macro(2300, 100, 575, 600, new Color(240, 64, 64), "QCPU"), //wrapped_qcpu
			new Macro(1475, 800, 200, 200, new Color(166, 166, 0), "MC14500"), //wrapped_mc14500
			...
			new Macro(1700, 800, 1225, 1225, new Color(19, 182, 222), "Tholin RISCV (RV32IM)"),
